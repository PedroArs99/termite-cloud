...
import { UpdateDeviceStateCommandHandler } from './application/commands/updateDeviceState/UpdateDeviceState.handler';

const commandHandlers = [
  RegisterDevicesCommandHandler,
  SaveHomeStateCommandHandler,
